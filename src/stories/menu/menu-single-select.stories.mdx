...
<!--menu line template-->
<div class="p-menu-trigger" [matMenuTriggerFor]="menu">
  <p-button iconAfter="chevron-down"
            iconAfterWidth="17"
            iconAfterHeight="17"
            [label]="menuTriggerName"
            [iconAfterStrokeWidth]="1.5"
...
<mat-menu #menu="matMenu" class="p-menu" [overlapTrigger]="false">
  <!--in case the menu should be closed after click-->
  <ng-template [ngIf]="!isSubMenu" [ngIfElse]="subMenu">
    <ng-container [ngTemplateOutlet]="closedOnSingleClick"></ng-container>
  </ng-template>

  <!--in case this menu is submenu and should not close the main menu-->
  <ng-template #subMenu>
...
<!--menu is closed after option is selected / clicked-->
<ng-template #closedOnSingleClick>

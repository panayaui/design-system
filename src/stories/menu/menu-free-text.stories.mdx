...
import {MenuFreeTextComponent} from 'projects/design-system-lib/src/public-api';
...
<Meta title='FreeText'
    component={MenuFreeTextComponent}
    decorators={[
      moduleMetadata({
          imports: [
              CommonModule,            
    ...
    args={{
      menuTriggerName: 'Free Text Menu',
      menuList: [
        { name: 'Contains', inputValue: '', selected: true },
        { name: 'Not contains', inputValue: 'smth' },
        { name: 'Empty' },
        { name: 'Not empty' }
      ],
      footerBtnFirst: {

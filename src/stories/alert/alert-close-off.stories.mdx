...
<Meta title='Components/Alert/Close Off'
...
<Canvas>
  ...
  <Story name="Action Right Medium"
    args={{
      type: AlertEnum.Medium,
      data: {
        icon: {iconName: 'bell'},
        messageMain: 'Notification message.',
        actionName: 'Action'
...
<Canvas>
  ...
  <Story name="Action Middle Medium"
    args={{
      type: AlertEnum.Medium,
      triggerBtnName: "Medium"
    }}>
